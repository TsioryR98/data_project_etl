...
def load_historical_data():
    ...
    df_historique  = pd.read_csv(file_path)
    
    df_historique ['timeS'] = pd.to_datetime(df_historique ['timeS'])
    
    return df_historique.rename(columns={ 
    ...
    }, inplace=True)  # Rename columns if necessary, currently empty
